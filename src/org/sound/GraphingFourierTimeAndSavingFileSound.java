...
public class GraphingFourierTimeAndSavingFileSound extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jpMakeSoundTimeExtLayout.setHorizontalGroup(
            ...
            .addGroup(jpMakeSoundTimeExtLayout.createSequentialGroup()
                .addComponent(jpMakeSoundTime, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
  ...
  private void jtbCaptureActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jtbCaptureActionPerformed
      ...
      final AudioFormat audioformat = new AudioFormat(8000 /*Frequency*/,
              8 /* two bytes per sample */, 2 /*Stereo*/, true /*Signed*/, true /*bigEndian*/);
                                  ...
                                  while ((qtyBytes = SnkPlotPIStream.read(incomingBytes)) != -1) {
                                      ...
                                      SwingWorker swingWorkerPlotFreq = new SwingWorker() {
                                          ...
                                          protected Void doInBackground() throws Exception {
                                              ...
                                              if (!a && b == 0) {
                                                  for (int i = 0; i < halfFFT.length; i++) {
                                                    
                                                      System.out.println(halfFFT[i]);
                                          
                                                      if (halfFFT[i] == 4000.3 || halfFFT[i] == 4000.6) {
                                                          a = true;
                                              ...
                                              if (a && b == 0) {
                                                  a= false;
                                                  b=1;
                                                  System.out.println("Found that Frequency");
                                                  tdLine.stop();
                                                  tdLine.close();
                                                  new Recorder();
    ...
    int i = 0;
    static final long RECORD_TIME = 94700;  // 1 minute
    boolean a = false;
    int b = 0;
